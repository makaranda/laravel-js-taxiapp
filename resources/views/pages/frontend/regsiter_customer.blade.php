...
<div class="site-breadcrumb" style="background: url({{ url('public/assets/img/breadcrumb/01.jpg') }})">
    <div class="container">
       <h2 class="breadcrumb-title">Register Customer</h2>
    ...
    <div class="container">
       ...
       <div class="col-md-5 mx-auto">
          <div class="login-form">
             ...
             <form action="#" id="customerRegisterForm" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}"  data-parsley-trigger="keyup" required>
                </div>
...
$(document).ready(function(){
    ...
    $('#customerRegisterForm').on('submit',function(event){
        ...
        if($('#customerRegisterForm').parsley().isValid())
        {
            ...
            $.ajax({
                url : "{{ route('register.customerform') }}",
                cache: false,
                ...
                error: function(xhr, status, error) {
                    $('.preloader').css({'display':'none'});
                    console.log("Error getting Register ! \n", xhr, status, error);
                    //$('#overlay').hide();
                }
            });
        }else{
